...
public class FBIS96_parser {
   ...
   // private ArrayList<Document>
    ...
    public ArrayList<String> getFbis_file_name_collection() {
        return fbis_file_name_collection;
    }

    public ArrayList<FBIS95_structure> getMy_fbis_container() {
        return my_fbis_container;
    }

    private ArrayList<String>fbis_file_name_collection;
    private  ArrayList<FBIS95_structure>my_fbis_container;

    public FBIS96_parser() {
        this.fbis_file_name_collection = new ArrayList<>();
        this.my_fbis_container = new ArrayList<>();
    }
    ...
    public void load_file() throws IOException {
      ...
      //          System.out.println(final_string_text);
                ...
                this.my_fbis_container.add(temp_structure);
        ...
        for (FBIS95_structure element :  this.my_fbis_container) {
