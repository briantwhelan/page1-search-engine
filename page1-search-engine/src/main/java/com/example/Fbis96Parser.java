...
/**
 * Parses Foreign Broadcast Information Service documents from 1996.
 * Usage:
 * <pre>
 ...
 * }
 * </pre>
 * The useful information is contained within the <DOCNO>, <TEXT>, and <TI> tags.
 * The <TI> is nested within <H3><TI></TI></H3>.
 * Only the DOC number, Text, and TI are sufficient.
 */
public class Fbis96Parser {
    ...
    public void folderLoader() {
        String folderPath = "./Assignment Two/fbis/";
